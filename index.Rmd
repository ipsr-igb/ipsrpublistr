...
```{r echo=FALSE}
source("~/ipsrpublistr/R/Functions_ipsrPubList.R")
library(rmarkdown)

latest <- read.table(file = "~/ipsrpublistr/latest_publist", header = FALSE, sep = "\t")
previous <- read.table(file = "~/ipsrpublistr/previous_publist", header = FALSE, sep = "\t")
